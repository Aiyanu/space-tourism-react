...
export default function Destination() {
  const { destinationData, currentDestination } = useSelector(
      ...
      <div className="mt-20 mb-16 md:mt-28 md:mb-0 text-white w-full lg:p-16">
        ...
        <div className="flex gap-16 flex-col lg:flex-row w-full h-full mt-4">
          <img
            ...
            className="max-w-[259px] md:max-w-sm lg:max-w-lg object-contain m-auto"
          ...
          <div className="text-center flex flex-col justify-between items-center lg:text-left gap-4">
              ...
              <div className="flex justify-between gap-4 items-center max-w-[286px] uppercase text-sm">
                {destinationData.map((destination, index) => (
                  ...
                  >
                    <span
                      className={`${
                        currentDestination === index && "active-tab"
                      } text-sm md:text-base barlow`}
                      key={index}
                    >
                      {destination.name}
                    </span>
            ...
            <h1 className="font-bellefair text-6xl md:text-7xl lg:text-8xl uppercase w-full ">
              {destination.name}
            </h1>
            <p className="max-w-md px-2 text-secondary font-barlow text-base lg:text-lg">
              {destination.description}
            </p>
            <div className="w-full max-w-md bg-white h-0.5 bg-opacity-10" />
            <div className="flex flex-col md:gap-32 md:flex-row md:justify-between">
              <div>
                <span className="text-secondary font-barlow text-sm">
                  AVG. DISTANCE
                </span>
