...
export default function Navbar() {
  ...
  return <div className="absolute flex items-center justify-between left-0 right-0 font-barlow text-[16px] uppercase text-center tracking-widest">
    ...
    <div className=" w-1/2 bg-white bg-opacity-10 h-0.5 hidden lg:block"/>
    <div className="hidden md:flex lg:[830px] items-center justify-around gap-4 p-8 bg-white bg-opacity-5 backdrop-blur-lg text-white">
